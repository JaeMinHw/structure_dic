...
def main() -> None:
    ...
    print(f"[INFO] 수직 픽셀 거리: {pixel_dist:.1f} px  →  "

          f"1 cm = {px_per_cm:.3f} px")
    ...
    while True:
        ...
        roi_blend = cv2.addWeighted(
            ...
            first_frame[by:by + bh, bx:bx + bw], OVERLAY_ALPHA,
        ...
        for i, txt in enumerate(hud_lines):
            ...
            cv2.putText(vis, txt, (18, 40 + i * 32),
